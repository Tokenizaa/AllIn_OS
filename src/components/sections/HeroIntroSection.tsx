          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            {primaryButtonLink ? (
              <Button 
                ...
                className="group font-semibold shadow-lg glass-button"
              >
                {primaryButtonText}
            ...
            {secondaryButtonLink && (
              <Link to={secondaryButtonLink}>
                <Button variant="vibrantOutline" size="lg" className="bg-white/10 backdrop-blur-sm text-allin-dark dark:text-allin-white transition-all glass-button">
                  {secondaryButtonText}
                </Button>
              </Link>
            )}
